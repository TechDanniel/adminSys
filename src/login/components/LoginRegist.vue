  ...
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="updateRules" size="large">
    ...
    <Motion :delay="100">
      <el-form-item prop="phone">
        <el-input v-model="ruleForm.phone" clearable placeholder="手机号" :prefix-icon="useRenderIcon(Iphone)" />
      </el-form-item>
    </Motion>
    ...
    <Motion :delay="150">
      <el-form-item prop="verifyCode">
        <div class="w-full flex justify-between">
          ...
          />
          <el-button :disabled="isDisabled" class="ml-2" @click="useVeriyfyCode().start(ruleFormRef, 'phone')">
            {{ text }}
          </el-button>
        </div>
      </el-form-item>
