  ...
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="phoneRules" size="large">
    ...
    <Motion>
      <el-form-item prop="phone">
        <el-input v-model="ruleForm.phone" clearable placeholder="请输入手机号" :prefix-icon="useRenderIcon(Iphone)" />
      </el-form-item>
    </Motion>
    ...
    <Motion :delay="100">
      <el-form-item prop="verifyCode">
        <div class="w-full flex justify-between">
          ...
          />
          <el-button class="ml-2" :disabled="isDisabled" @click="useVeriyfyCode().start(ruleFormRef, 'phone')">
            {{ text }}
          </el-button>
        </div>
      </el-form-item>
