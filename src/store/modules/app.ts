...
export const useAppStore = defineStore('app', {
  state: (): appType => ({
    sidebar: {
      ...
      opened:
        ReactiveStorage.getItem<StorageConfigs>(`${responsiveStorageNameSpace()}layout`)?.sidebarStatus ??
    ...
    layout:
      ReactiveStorage.getItem<StorageConfigs>(`${responsiveStorageNameSpace()}layout`)?.layout ?? getConfig().Layout,
