  ...
  <div :class="['w-[99/100]', 'px-2', 'pb-2', 'bg-bg_color', 'mt-2']">
    <div class="flex justify-between w-full h-[60px] p-4">
      ...
      <div class="flex items-center justify-around">
        <!-- 按钮 -->
        <slot name="buttons"
          ><div class="flex mr-4" v-if="slots?.buttons">{{ slots.buttons() }}</div></slot
        >
        ...
        <el-divider direction="vertical" />
        <!-- 选定列展示 -->
        <el-popover placement="bottom-start" :popper-style="{ padding: 0 }" width="200" trigger="click">
          <template #reference>
          ...
          <div class="pt-[6px] pl-[11px]">
            <el-scrollbar max-height="36vh">
              <el-checkbox-group :ref="GroupRef" v-model="checkedColumns" @change="handleCheckedColumnsChange">
...
import { PropType, computed, ref, useSlots, unref, getCurrentInstance } from 'vue'
...
//过滤掉隐藏的列
const filterColumns = deepClone(props?.columns).filter(column => !column.hide)
//所有列的label属性，标识
