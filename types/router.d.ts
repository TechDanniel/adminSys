...
declare global{
  ...
  /**路由守卫to,from的类型 */
  //RouteLocationNormalized是一个表示规范化后的路由位置的对象，在路由导航守卫（像 beforeEach、beforeResolve、afterEach 等）里，传递的 to 和 from 参数就属于 RouteLocationNormalized 类型。
  interface ToRouteType extends RouteLocationNormalized {
    meta: CustomizeRouteMeta;
  }
}

// 扩展 vue-router 库中 RouteMeta 接口的类型定义
